...
public class WeightedGraphImpl implements Graph {
    ...
    public static void main(String[] args) {
        WeightedGraphImpl weightedGraph1 = new WeightedGraphImpl("graph/weighted-graph.txt", false);
        System.out.println(weightedGraph1);
        WeightedGraphImpl weightedGraph2 = new WeightedGraphImpl("graph/weighted-graph.txt", true);
        System.out.println(weightedGraph2);
    }
}
