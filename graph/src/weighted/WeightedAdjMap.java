...
// 无向有权图
// 空间复杂度：O(V + E)
public class WeightedAdjMap implements Graph {
    private int V; // 顶点的个数
    private int E; // 边的个数
    private TreeMap<Integer, Integer>[] adj; // 邻接表

    // 建图时间复杂度：O(E * logV)
    public WeightedAdjMap(String fileName) {
        try {
    ...
    public static void main(String[] args) {
        WeightedAdjMap weightedAdjMap = new WeightedAdjMap("graph/weighted-graph.txt");
        System.out.println(weightedAdjMap);
    }
}
